...
func setup(enemies:int, damage_done:int, damage_taken:int, money:int, scraps:int, cores:int, success: String, grade_index)->void:
	...
	_animate_counters(enemies, damage_done, damage_taken, money, scraps, cores, grade_index)

func _animate_counters(target_enemies:int, target_damage_done:int, target_damage_taken:int, target_money:int, target_scraps:int, target_cores:int, target_grade_index:int):
