...
func _on_resolution_select(index: int):
...
func _on_vsync_toggled(enable: bool):
	var mode = DisplayServer.VSYNC_ENABLED if enable else DisplayServer.VSYNC_DISABLED
